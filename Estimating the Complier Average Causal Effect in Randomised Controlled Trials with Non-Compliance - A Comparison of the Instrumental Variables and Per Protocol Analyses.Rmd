...
This document contains the code used in the main simulation analysis employed at the paper titled "Estimating the Complier Average Causal Effect in Randomised Controlled Trials with Non-Compliance: A Comparative Simulation Analysis of the Instrumental Variables and Per Protocol Methods". To replicate the following simulations you can use the code as provided setting the seed equal to 24.
