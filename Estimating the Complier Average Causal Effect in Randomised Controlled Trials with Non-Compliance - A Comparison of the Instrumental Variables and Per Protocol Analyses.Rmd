...
The main simulation analysis presented here considers only Case I. For the other three see the Sensitivity Analyses file.
For more details on the structure of the simulations see the final version of the Thesis.


In this file we only present the code for the main simulation analysis. Their results are summarised in the Tables in Section 3 of the thesis. For the sensitivity analyses please see the "Sensitivity Analyses.Rmd" file.
