...
This is an R Markdown document that contains the main simulation analysis employed during the MSc Research Project at the Department of Mathematics of Imperial College of London titled "Estimating the Complier Average Causal Effect in Randomised Controlled Trials with Non-Compliance: A Comparative Simulation Analysis of the Instrumental Variables and Per Protocol Methods" from MSc student Theodosios (Theo) Papazoglou. The simulation employed is described substantially in Section 2.5 of the thesis.
To replicate the following simulations you can use the code as provided setting the seed equal to 24.
...
The results are summarised in Tables 3 and 4 in Section 3 of the thesis. A second file named "Sensitivity Analyses" is available and contains all sensitivity analyses employed and described in Section 2.5 of the thesis.
